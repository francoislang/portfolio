  ...
  <div class="bg-white text-left basis-2/3 p-5 grid grid-cols-1 overflow-y-hidden overflow-y-scroll animate-reveal">
    ...
    <div class=" flex flex-row w-full h-fit p-5  bg-white duration-1000 hover:drop-shadow-md hover:bg-[#d9c4b6]">
      <div class="basis-2/3">
        ...
        <div>
          <p>
          Pour apprendre les bases de l'intelligence artificielle, j'ai codé un neurone simple permettant de distinguer
          si une plante est toxique ou non.
          </p>
        </div>
      </div>
      <img src="@/assets/decision_boundary_single_neuron.png" class="w-1/2 h-1/2" >
    </div>
  </div>
</div>
